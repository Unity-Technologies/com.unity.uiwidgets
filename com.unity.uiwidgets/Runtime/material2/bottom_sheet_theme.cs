    ...
    public class BottomSheetThemeData : Diagnosticable, IEquatable<BottomSheetThemeData> {
        ...
        public static BottomSheetThemeData lerp(BottomSheetThemeData a, BottomSheetThemeData b, float t) {
            ...
            return new BottomSheetThemeData(
              ...
              modalElevation: MathUtils.lerpFloat((float)a?.modalElevation.Value, (float)b?.modalElevation.Value, t),
        ...
        public override void debugFillProperties(DiagnosticPropertiesBuilder properties) {
            ...
            properties.add( new DiagnosticsProperty<Clip>("clipBehavior", clipBehavior.Value, defaultValue: null));
        }
        ...
        public bool Equals(BottomSheetThemeData other)
        {
            ...
            return Equals(backgroundColor, other.backgroundColor) 
                   ...
                   && Nullable.Equals(modalElevation, other.modalElevation) 
