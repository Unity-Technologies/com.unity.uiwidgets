...
namespace Unity.UIWidgets.material {
  ...
  return null;
            ...
            return new ConstrainedBox(
                    ...
                    child: new Material(
                        ...
                        child: new InkWell(
                            ...
                            child: new Text(formattedMinute, style: minuteStyle, textAlign: TextAlign.start, textScaleFactor: 1.0f)
                        )
                    )
            );
        }
    ...
    class _TimePickerHeaderLayout : MultiChildLayoutDelegate {
        ...
        void _positionPivoted(float width, float y, Dictionary<_TimePickerHeaderId, Size> childSizes, List<_TimePickerHeaderFragment> fragments, int pivotIndex) {
        ...
        void _positionPiece(float width, float centeredAroundY, Dictionary<_TimePickerHeaderId, Size> childSizes, List<_TimePickerHeaderFragment> fragments) {
    ...
    switch (themeData.primaryColorBrightness) {
     ...
     _TimePickerHeaderFormat format = TimePickerUtils._buildHeaderFormat(timeOfDayFormat, fragmentContext, orientation);
     ...
     var children = childrenPieces.Select<_TimePickerHeaderFragment, Widget>((_TimePickerHeaderFragment fragment) => {
         return new LayoutId(
    ...
    class _Dial : StatefulWidget {
        ...
        public override State createState() => new _DialState();
    }
    ...
    class _DialState : SingleTickerProviderStateMixin<_Dial> {
        public override void initState() {
            ...
            _thetaTween = new Tween<float>(begin: _getThetaForTime(widget.selectedTime));
            _theta = _thetaController
                .drive(new CurveTween(curve: Curves.fastOutSlowIn))
                .drive(_thetaTween);
                _theta.addListener(() => setState(() => { /* _theta.value has changed */ }));
        }
